...
APPHOST_SOURCES := \
	...
	src/loushang/tui/ui_parts/composer.py \
...
lint-appservice:
	uv --cache-dir .uv-cache run --extra dev ruff check $(APPSERVICE_SOURCES) $(APPSERVICE_TEST_PATHS) tests/coding/_hosted_product_child.py tests/coding/_local_product_child.py
