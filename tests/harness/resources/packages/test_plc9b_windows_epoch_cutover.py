...
def test_windows_cutover_releases_every_native_descriptor(
    ...
    monkeypatch.setattr(windows_epoch_cutover, "_open_ancestor_chain", tracking_open_chain)
    monkeypatch.setattr(windows_epoch_cutover, "_open_directory_at", tracking_open_directory_at)
