...
CONTINUITY_PROVIDER_PAYLOAD_VERSION = 1
...
class ContinuityProviderDeclarationWirePayloadV1:
    ...
    payload_version: int = CONTINUITY_PROVIDER_PAYLOAD_VERSION
    ...
    def __post_init__(self) -> None:
        ...
        if self.payload_version != CONTINUITY_PROVIDER_PAYLOAD_VERSION:
    ...
    def from_dict(cls, value: object) -> Self:
        ...
        if version != CONTINUITY_PROVIDER_PAYLOAD_VERSION:
            _raise_codec(
