...
- Delivery status: PLC0 is implemented locally at `25cfc170`; its exact source
  ...
  complete. PLC2-1 through PLC2-4C are implemented; PLC2-4D and later slices
...
PLC2-1, PLC2-2, PLC2-3, PLC2-4A, PLC2-4B and PLC2-4C are implemented;
PLC2-4D remains gated.
