...
- Delivery status: implemented, terminally reviewed from architecture,
  correctness/security, and Product/test perspectives, and merged under issue
  `#507` before the PLC8 entry gate opened.
