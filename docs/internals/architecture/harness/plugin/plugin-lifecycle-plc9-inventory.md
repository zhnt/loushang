...
- PLC9D3e refinement:
  ...
  adds a journal for exact-start Store results and retryable errors, with
  exact-settlement result matching; no coordinator has yet proven that a
  result follows actual Store mutation.
