...
The final narrow correction removes the mutable Coordinator codec attribute and
calls the stateless class/static codec entrypoint directly, while forbidding
import shadowing; it does not change the authoring SPI or delivery order.
