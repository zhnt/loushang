...
| AppHost | partial | A0.1--A0.4, G8, and G9.0--G9.3 are implemented; the source-backed G9.3 decision retains Current because all eight deletion conditions remain unmet | reconcile/promote the default-dark capability in G9.4; explicit activation, Current deletion, launcher, AppServer runtime, and AppService remain separate | AppHost ARD-003, G9 closure, and AppHost scope |
