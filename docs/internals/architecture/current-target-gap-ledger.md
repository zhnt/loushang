...
| AppHost | partial | A0.1--A0.4, G8, and G9.0--G9.2 are implemented; the sole explicit Product composition and rollback/crash evidence remain default-dark and Current paths are unchanged | record a G9.3 Current-owner RETAIN/DELETE decision, then reconcile/promote in G9.4; launcher, AppServer runtime, and AppService remain separate | AppHost ARD-003, G9 closure, and AppHost scope |
