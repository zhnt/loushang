...
| AppHost | partial | accepted top-level placement plus A0.1 immutable standard-library contracts and catalog-input validation; no production composition | implement A0.2 pinned catalog/routing and A0.3 canonical live bindings/embedded profile before optional hosted or launcher edges | AppHost ARD-003 and AppHost scope |
