...
| AppHost | partial | A0.1--A0.4 plus G8 are implemented; G9.0 accepts the closure gates but adds no production composition or activation | implement G9.1 explicit composition and G9.2 operational evidence, record a G9.3 Current-owner RETAIN/DELETE decision, then reconcile/promote in G9.4; launcher, AppServer runtime, and AppService remain separate | AppHost ARD-003, G9 closure, and AppHost scope |
